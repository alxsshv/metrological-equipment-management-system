...
public class MeasuringInstrumentDataDto {
    @XmlElement(name = "VerificationMeasuringInstrument")
    private ArrayList<MeasurementInstrumentDto> instruments  = new ArrayList<>();

    public void add(MeasurementInstrumentDto instrument){
